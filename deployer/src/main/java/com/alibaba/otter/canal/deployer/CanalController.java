...
public class CanalController {
    ...
    // 默认使用spring的方式载入
    private final Map<String, InstanceConfig> instanceConfigs;
    private final InstanceConfig globalInstanceConfig;
    private final Map<String, PlainCanalConfigClient> managerClients;
    // 监听instance config的变化
    private boolean autoScan;
    private InstanceAction defaultAction;
    private Map<InstanceMode, InstanceConfigMonitor> instanceConfigMonitors;
    private final CanalServerWithEmbedded embededCanalServer;
    ...
    private final String adminPasswd;
     ...
     * 3.准备一下canal-server，核心在于 embededCanalServer，如果有需要canalServerWithNetty，那就多包装一个（我们serverMode=mq是不需要这个netty的）
     * 4.初始化zkClient
     * 5.初始化ServerRunningMonitors，作为 instance 运行节点控制
    ...
    public CanalController(final Properties properties) {
        ...
        // 3.准备canal server
        //note: 核心在于embededCanalServer，如果有需要canalServerWithNetty，那就多包装一个（我们serverMode=mq 是不需要这个netty的）
        ...
        ServerRunningMonitors.setRunningMonitors(MigrateMap.makeComputingMap((Function<String, ServerRunningMonitor>) destination -> {
            ...
            runningMonitor.setListener(new ServerRunningListener() {
                 ...
                 * 2.停止embededCanalServer的destination
                 */
     ...
     * 4.如果canalServer不为空，启动canalServer (canalServerWithNetty)
     *
     * @throws Throwable
     */
